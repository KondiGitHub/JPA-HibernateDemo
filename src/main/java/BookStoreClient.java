...
public class BookStoreClient {
    public static void main(String[] args) {
        ...
        Publisher publisher = new Publisher("BANN", "Manning Publications Co.");


        Book book = new Book("3781617290459", "Java Persistence with Hibernate, Second Edition", publisher);
